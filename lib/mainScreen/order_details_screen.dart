...
import 'package:lapo_try/widgets/shipment_address_design.dart';
import 'package:lapo_try/widgets/status_banner.dart';
            ...
            ? Container(
              child: Column(
                children: [
                  ...
                  orderStatus != "ended" 
                  ? Image.asset("images/images/packing.png") 
                  : Image.asset("images/images/delivered.jpg"),
                  const Divider(thickness: 4,),
