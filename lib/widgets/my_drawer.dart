...
import 'package:lapo_try/mainScreen/earnings_screen.dart';
import 'package:lapo_try/mainScreen/history_screen.dart';
import 'package:lapo_try/mainScreen/home_screen.dart';
import 'package:lapo_try/mainScreen/new_orders_screen.dart';
            ...
            Container(
              ...
              child: Column(
                children: [
                    ...
                    ListTile(
                      leading: const Icon(Icons.fastfood_sharp, color: Colors.black,),
                      title: const Text(
                        "History of Orders",
                        style: TextStyle(color: Colors.black),
                      ),
